...
export default function CallCenterDashboard() {
  ...
  return (
    <div className="min-h-screen bg-gray-200">
      ...
      <header className="bg-white relative border-b border-gray-300">
        <div
          className="absolute top-0 right-0 h-[calc(100%+12px)] z-40 w-full bg-[url('/icon.png')] bg-no-repeat"
          style={{
      ...
      <div className="p-3 bg-lightred">
        ...
        <div>
          ...
          <div className="relative overflow-hidden">
            ...
            <div className="absolute top-0 bottom-px right-0 w-[24px] bg-scrollbar">
              <Image
                src="/scrollbar.png"
                alt="scrollbar"
                width={24}
